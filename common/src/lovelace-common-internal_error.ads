...
package Lovelace.Common.Internal_Error is
   ...
   function Make (Group : Error_Group; Message : String) return Lovelace_Internal_Error;

   --  UTF-8 detail string only.
   --  @param Item Internal error to read.
   --  @return Contents of Message.
   function Detail (Item : Lovelace_Internal_Error) return String;
   ...
   function Report (Item : Lovelace_Internal_Error) return String;
