...
package body Lovelace.Compiler.Backend.Lowering is
   ...
   function Signature_Is_Supported (The_Signature : Subroutines.Signature) return Boolean;
      ...
      begin
         for Subroutine_Index in 1 .. Modules.Subroutine_Count (The_Module) loop
            ...
            begin
               ...
               if Subroutines.Has_Export (The_Flags) then
                  Model.Append_Export
                    (The_Model,
                     (Export_Name         => The_Signature.Name,
         ...
         if Entrypoint_Found then
            ...
            begin
               ...
               Model.Append_Export
                 (The_Model,
                  (Export_Name         => Ada.Strings.Unbounded.To_Unbounded_String ("run"),
   ...
   function Signature_Is_Supported (The_Signature : Subroutines.Signature) return Boolean is
   begin
      return The_Signature.Return_Type = Types.Unit and then Types.Length (The_Signature.Parameter_Types) = 0;
